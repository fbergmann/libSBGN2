...
message("Creating: libsbgncsP.dll")
...
if (EXISTS ${BIN_DIRECTORY}/libsbgncsP.dll)
    file(REMOVE ${BIN_DIRECTORY}/libsbgncsP.dll)	
endif()
...
file(TO_NATIVE_PATH ${BIN_DIRECTORY}/libsbgncsP.dll MANAGED_LIB)
