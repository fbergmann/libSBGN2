...
#ifndef LIBSBGN_COMMON_H
#define LIBSBGN_COMMON_H 1
...
/**
 * Default format used by libSBGN when writing out floating-point numbers
 * into the XML produced by libSBGN.  This is used by
 * StringBuffer_appendReal.
 */
#define LIBSBGN_FLOAT_FORMAT "%.15g"

#define LIBSBGN_DOUBLE_PRECISION 15

static const int SBGN_INT_MAX = 2147483647;
static const int SBGN_INT_MIN = -2147483647 - 1;
...
#define LIBSBGN_UNKNOWN_LINE	SBGN_INT_MAX
#define LIBSBGN_UNKNOWN_COLUMN	SBGN_INT_MAX
