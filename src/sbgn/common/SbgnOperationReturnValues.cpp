/**
 * @file SbgnOperationReturnValues.cpp
 * @brief Implementation of the SbgnOperationReturnValues class.
 * @author DEVISER
 *
 * <!--------------------------------------------------------------------------
...
static SbgnOperationReturnValues_t SBGN_OPERATION_RETURN_VALUES_INDICES[] = 
{
    LIBSBGN_OPERATION_SUCCESS
  , LIBSBGN_INDEX_EXCEEDS_SIZE
  , LIBSBGN_UNEXPECTED_ATTRIBUTE
  , LIBSBGN_OPERATION_FAILED
  , LIBSBGN_INVALID_ATTRIBUTE_VALUE
  , LIBSBGN_INVALID_OBJECT
  , LIBSBGN_DUPLICATE_OBJECT_ID
  , LIBSBGN_LEVEL_MISMATCH
  , LIBSBGN_VERSION_MISMATCH
  , LIBSBGN_INVALID_XML_OPERATION
  , LIBSBGN_NAMESPACES_MISMATCH
  , LIBSBGN_DUPLICATE_ANNOTATION_NS
  , LIBSBGN_ANNOTATION_NAME_NOT_FOUND
  , LIBSBGN_ANNOTATION_NS_NOT_FOUND
  , LIBSBGN_MISSING_METAID
  , LIBSBGN_DEPRECATED_ATTRIBUTE
};

static const char* SBGN_OPERATION_RETURN_VALUES_STRINGS[] =
{
  ...
  , /*LIBSBGN_DUPLICATE_ANNOTATION_NS = -11*/
   ...
   "typically returned in situations where the appendExtension function "
  ...
  , /*LIBSBGN_ANNOTATION_NAME_NOT_FOUND = -12*/
   ...
   "replaceTopLevelExtensionElement function or "
   "the removeTopLevelExtensionElement function "
...
{
  int length = sizeof(SBGN_OPERATION_RETURN_VALUES_INDICES)/sizeof(SbgnOperationReturnValues_t);
  for (int i = 0; i < length; ++i)
  {
    if (SBGN_OPERATION_RETURN_VALUES_INDICES[i] == returnValue)
      return SBGN_OPERATION_RETURN_VALUES_STRINGS[i];
  }
