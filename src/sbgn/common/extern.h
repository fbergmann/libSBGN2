 ...
 * LIBSBGN_EXTERN functions as being imported from a DLL, wheras this DLL
 * sees symbols defined with this macro as being exported.
 *
 * (From Andrew Finney's sbwdefs.h, with "SBW" replaced by "LIBSBGN" :)
 */
#if defined(LIBSBGN_EXPORTS)
#  define LIBSBGN_EXTERN __declspec(dllexport)
#else
#  define LIBSBGN_EXTERN __declspec(dllimport)
#endif

#else
#  define LIBSBGN_EXTERN
#endif  /* LIBSBGN_STATIC */
...
/**
 * LIBSBGN_EXTERN is used under Windows to simplify exporting functions
 ...
 * LIBSBGN_EXTERN that is appropriate for exporting functions to client
